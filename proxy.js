...
const server = http.createServer(function(req, res) {
    ...
    const connector = (options.protocol == 'https:' ? https : http).request(options, function(serverResponse) {
        ...
        switch (serverResponse.statusCode) {
            ...
            default:
                const stringifiedHeaders = JSON.stringify(serverResponse.headers, null, 4);
                serverResponse.resume();
                res.writeHeader(500, {
